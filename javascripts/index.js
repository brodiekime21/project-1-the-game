...
dancefloor.src = "./assets/images/dancefloor.png";

const bouncer = new Image();
bouncer.src = "./assets/images/bouncer.png";

const drunkGirl = new Image();
drunkGirl.src = "./assets/images/drunkGirl.png";

const drunkGuy = new Image();
drunkGuy.src = "./assets/images/drunkGuy.png";

const taylorSwift = new Image();
taylorSwift.src = "./assets/images/taylorSwift.png";

const badBunny = new Image();
badBunny.src = "./assets/images/badBunny.png";
...
const song1 = new Audio(
  "./assets/songs/Mad World - Tears for Fears (Brodie Killem Edit) 1 minute.wav"
);
const song2 = new Audio("./assets/songs/Last Christmas 1 minute for game.wav");
const song3 = new Audio("./assets/songs/Gorillaz 1 minute for game.wav");

const spindown = new Audio("./assets/songs/cd_fx_spindown.wav");
...
function checkCollisionT(obstacleT) {
  if (
    player.y < obstacleT.y + obstacleT.height &&
...
function checkCollisionB(obstacleB) {
  if (
    player.y < obstacleB.y + obstacleB.height &&
...
function checkCollisionWithDj(obstacle) {
  (cx = 375), (cy = 375), (r = 87.5), (rx = obstacle.x);
  ry = obstacle.y;
  rw = obstacle.width;
  rh = obstacle.height;
  testX = cx;
...
function checkCollisionWithDj2(obstacle2) {
  (cx = 375), (cy = 375), (r = 87.5), (rx = obstacle2.x);
  ry = obstacle2.y;
  rw = obstacle2.width;
  rh = obstacle2.height;
  testX = cx;
...
function checkCollisionWithDjT(obstacleT) {
  (cx = 375), (cy = 375), (r = 87.5), (rx = obstacleT.x);
  ry = obstacleT.y;
  rw = obstacleT.width;
  rh = obstacleT.height;
  testX = cx;
...
function checkCollisionWithDjB(obstacleB) {
  (cx = 375), (cy = 375), (r = 87.5), (rx = obstacleB.x);
  ry = obstacleB.y;
  rw = obstacleB.width;
  rh = obstacleB.height;
  testX = cx;
